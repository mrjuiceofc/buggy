...
if (anu.action == 'add') {
    haikal.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `Hello *@${num.split("@")[0]}* Welcome To *${metadata.subject}* 👋
 ▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Dont Forget To Support Us
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Website : https://mrjuiceofc1.blogspot.com/?m=1
Youtube : https://www.youtube.com/@mrjuiceofc
Telegram : https://t.me/DeveloperJuice
Instagram : https://www.instagram.com/mr_juice7` })
...
Instagram : https://www.instagram.com/mr_juice7` })
    ...
    haikal.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split('@')[0]} Bro Has Been Mad Admin In ${metadata.subject} ${metadata.desc}` })
} else if (anu.action == 'demote') {
    haikal.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split('@')[0]} I see bro is nolonger a admin in ${metadata.subject} ${metadata.desc}` })
              }
            }
        } catch (err) {
            /*console.log(err)*/
...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await haikal.getName(i + '@s.whatsapp.net')}\nFN:${await haikal.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:mrjuice017@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://https://www.instagram.com/mr_juice7\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;U.S.A New York;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`})}
//=================================================//
